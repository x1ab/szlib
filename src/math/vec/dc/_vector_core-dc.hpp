...
#ifndef _DCV567B3IM03F609845B6709845380FVEWMRUY089ERTYH_
#define _DCV567B3IM03F609845B6709845380FVEWMRUY089ERTYH_
...
#ifdef VEC_DEBUG
# include "../ios.hpp"  // Can be disabled with VEC_NO_IOS, but still needed for the syntax!
...
#include "vector-dc-fw.hpp" //! Including only for double-checking: should fail if out of sync!
...
std::cerr << "[Vector: CTOR with opaque foreign data (which we can't print...)]\n";
	...
	// And its op= pair (-> #20):
#ifndef _TODO_VEC_NO_OPEQ_FOREIGN
...
#endif // _TODO_VEC_NO_OPEQ_FOREIGN
...
//----------------------------------------------------------------------------
// We also need an entry for Vector in VEC_NAMESPACE::Vector_traits. (-> #19)
...
struct Vector_traits< VEC_DIRECT_COORD_SUBNAMESPACE::Vector<Dim, NumT, Adapter> > {
...
//----------------------------------------------------------------------------
#define Self VEC_DIRECT_COORD_SUBNAMESPACE::Vector<Dim, NumT, A>
#include "../ops.hpp"
#undef Self
...
namespace VEC_NAMESPACE::VEC_DIRECT_COORD_SUBNAMESPACE {
	...
	using VEC_NAMESPACE::operator*;
	using VEC_NAMESPACE::operator/;
	using VEC_NAMESPACE::dot;

} // namespace VEC_NAMESPACE::VEC_DIRECT_COORD_SUBNAMESPACE


#endif // _DCV567B3IM03F609845B6709845380FVEWMRUY089ERTYH_
