...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - -- - - - - - - - - -
//!!TBD:#ifndef VEC_NO_NAMED_COORDS //!! But then do this at every other such place!
...
//!! the name is already introduced, and will stick; it would just get disabled, but
//!! still clash, being "ambiguous" (if my, and ChatGPT's, understanding is correct).
	// Getters:
